            ...
            <div class="flex flex-col w-64 bg-gray-800">
                ...
                <div class="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
                    <nav class="flex-1 space-y-2">
                        <!-- Dashboard Link -->
                        <a href="" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md transition duration-200 {{ request()->routeIs('admin.dashboard') ? 'bg-gray-700 text-white' : '' }}">
                        ...
                        <!-- Bookings Link -->
                        <a href="" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md transition duration-200 {{ request()->routeIs('admin.bookings.*') ? 'bg-gray-700 text-white' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <!-- Users Link -->
                        <a href="" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md transition duration-200 {{ request()->routeIs('admin.users.*') ? 'bg-gray-700 text-white' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <form method="POST" action="">
                            ...
                            <button type="submit" class="flex-shrink-0 group block">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-base font-medium text-white">Logout</p>
                                    </div>
                                </div>
                            </button>
                        </form>
